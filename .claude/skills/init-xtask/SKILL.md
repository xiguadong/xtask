...
cp -r /path/to/xtask/.claude/skills/xtask-safe .claude/skills/
cp -r /path/to/xtask/.claude/skills/xtask-work .claude/skills/
cp -r /path/to/xtask/.claude/skills/xtask-summary .claude/skills/
cp -r /path/to/xtask/.claude/skills/init-xtask .claude/skills/
```
