---
name: xtask-work
description: "xtask 任务执行工作流。当用户提示这是 xtask 分支、需要开始 xtask 任务时触发。运行 .claude/skills/xtask-work/scripts/xtask-work.sh 获取任务信息，使用 xtask-safe 管理状态，使用 xtask-todo 管理文档。"
---
...
```bash
bash .claude/skills/xtask-work/scripts/xtask-work.sh
```
